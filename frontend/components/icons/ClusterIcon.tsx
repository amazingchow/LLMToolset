...
interface ClusterIconProps extends React.SVGProps<SVGSVGElement> {
  color?: string;
  size?: number;
}

// 使用 forwardRef 可以让你像对DOM元素一样传递 ref
const ClusterIcon = React.forwardRef<SVGSVGElement, ClusterIconProps>(
  ({ color = 'currentColor', size = 32, ...props }, ref) => (
    <svg
      ref={ref}
